#!/usr/bin/env python3
"""
Script genérico para geração de diagramas usando APIs de geração de imagens.

Uso:
    python main.py --prompt "Crie um diagrama..." --output-filename diagram.png
    python main.py --prompt-file prompt.txt --output-filename diagram.png
"""
...
from scripts.diagram_generator.generators import DiagramGenerator
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Gera diagramas de algoritmos de ordenação"
    )
    ...
    if args.output_dir:
        ...
        # Se não especificado, usar diretório atual/output
        config.output_dir = Path.cwd() / "output"
